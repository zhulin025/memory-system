 ...
 * 生成记忆提取 Prompt
 */
export function buildExtractPrompt(newMessageCount, existingMemories, skipIndex = false) {
...
function buildHowToSaveWithIndex() {
    return `
保存记忆是两步流程：
...
// Dream Prompt
// ============================================================================
export function buildDreamPrompt(memoryRoot, transcriptDir, maxIndexLines, maxIndexBytes) {
    return `
# Dream: 记忆整理
